...
class EnhancedAuthService {
  ...
  static Future<PersonaEntity> _getPersonaByIdDirect(int idPersona) async {
    try {
      ...
      if (response == null) {
        throw ServerException(
          message: "No se encontraron datos de persona para $idPersona",
        );
      }

      final persona = PersonaEntity.fromJson(response);
      _validatePersonaEstado(persona);
      return persona;
    } catch (e) {
  ...
  static Future<TsegUsuarioEntity> getUserById(int idUsuario) async {
    try {
      if (!isLoggedIn) {
      ...
      return TsegUsuarioEntity.fromJson(response);
    } catch (e) {
      if (e is ServerException) rethrow;
      throw ServerException(
          message: "Error obteniendo datos de persona: ${e.toString()}");
