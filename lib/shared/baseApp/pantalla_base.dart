...
class _PantallaBaseState extends ConsumerState<PantallaBase> {
  ...
  Widget build(BuildContext context) {
    Widget scaffold = Scaffold(
      ...
      drawer: PlatformUtil.isDesktop || PlatformUtil.isWeb
          ? null
          : AppDrawer(
              currentIndex: 0,
              userRole: rol,
      ...
      bottomNavigationBar: PlatformUtil.isDesktop || PlatformUtil.isWeb
          ? null
          : AppBottomNav(
              currentIndex: 0,
              onTap: (index) {
                ...
                if (widget.onSectionChange != null) {
                  widget.onSectionChange!(index);
                  debugPrint(
                      ' IDE: onSectionChange: ${widget.onSectionChange}');
                  Navigator.of(context).pop();
                } else {
