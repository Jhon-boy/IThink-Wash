...
import 'package:ithinkwash/modules/user/domain/mappers/persona_mapper.dart';
import 'package:ithinkwash/modules/user/domain/mappers/usuario_mapper.dart';
...
import 'package:ithinkwash/modules/user/presentation/crear_usuario_page.dart';
import 'package:ithinkwash/modules/user/presentation/widget/dialogo_gestionar_widget.dart';
import 'package:ithinkwash/modules/user/presentation/widget/dialogo_sucursales_widget.dart';
import 'package:ithinkwash/modules/user/presentation/widget/empleado_card_widget.dart';
import 'package:ithinkwash/modules/user/presentation/widget/shimmer_widget.dart';
...
class _EmpleadosPageState extends ConsumerState<EmpleadosPage> {
  ...
  Future<void> _cargarEmpleados() async {
    ...
    try {
      ...
      final usuariosUnicos = <int, TsegUsuarioEntity>{};
  ...
  Future<void> _buscarPersona(String identificacion) async {
    ...
    try {
      ...
      final personaData =
          await _personaDataSource.getPersonaById(identificacion);
  ...
  Future<void> _actualizarEmpleadoConUsuario(
      EmpleadoModel empleado, TsegUsuarioEntity usuarioCreado) async {
    final appState = ref.watch(appStateProvider);
    appState.setLoading(true);
  ...
  Future<void> _eliminarEmpleado(EmpleadoModel empleado) async {
    ...
    try {
      ...
      final personaActualizada = await _personaDataSource.updatePersonaById(
